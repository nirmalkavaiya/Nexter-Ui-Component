...
function K({
  ...
  const h = typeof d == "string" ? d.trim() : "", M = !!h, b = e || n, A = typeof t == "string" && /<[a-z][\s\S]*>/i.test(t), B = D(
    (g) => {
      const H = { target: { checked: g } };
      l == null || l(H), p == null || p(g);
    },
    [l, p]
  ), C = R(
    () => $("nxp-ftc nxp-bg-default nxp-p-20 nxp-rounded-md", e && "nxp-ftc--locked", n && "nxp-ftc--disabled", m),
    [e, n, m]
  );
  return /* @__PURE__ */ c("div", { className: "nxp-ftc-outer", children: [
    M && /* @__PURE__ */ a("span", { className: "nxp-ftc-plan", children: h }),
    /* @__PURE__ */ c("div", { className: C, children: [
      /* @__PURE__ */ c("div", { className: "nxp-ftc__body", children: [
        /* @__PURE__ */ c("div", { className: "nxp-ftc__title-row", children: [
          /* @__PURE__ */ a("span", { className: "nxp-title-label nxp-cursor-pointer", children: s }),
          v && /* @__PURE__ */ a("span", { className: "nxp-ftc__badge nxp-ftc__badge--new", "aria-label": "New", children: "NEW" }),
          w && o && /* @__PURE__ */ a(
            "span",
            {
              className: u[y] ?? u.default,
              "aria-label": `${o} feature`,
              children: o
            }
          ),
          i && /* @__PURE__ */ a(z, { content: i, position: I, children: /* @__PURE__ */ a(
            "span",
            {
        ...
        /* @__PURE__ */ c("div", { className: "nxp-ftc__right", children: [
          _ && !e && /* @__PURE__ */ a(
            ...
            {
              type: "button",
              className: "nxp-ftc__settings-btn" + (r ? " setting-enable" : ""),
              onClick: _,
              disabled: !r || n,
      ...
      /* @__PURE__ */ c("div", { className: "nxp-ftc__links", children: [
        ...
        ) : /* @__PURE__ */ a("div", { className: "nxp-body nxp-mt-12 nxp-lh-22", children: t })),
        f && /* @__PURE__ */ a(
          "a",
          {
            href: f,
