...
function L({
  ...
  const h = typeof d == "string" ? d.trim() : "", B = !!h, m = c || r, I = typeof a == "string" && /<[a-z][\s\S]*>/i.test(a);
  function A(b) {
  ...
  return /* @__PURE__ */ n("div", { className: M, children: [
    B && /* @__PURE__ */ e("span", { className: "nxp-ftc-plan", children: h }),
    /* @__PURE__ */ n("div", { className: j, children: [
      /* @__PURE__ */ n("div", { className: "nxp-ftc__body", children: [
        /* @__PURE__ */ n("div", { className: "nxp-ftc__title-row", children: [
          ...
          u && /* @__PURE__ */ e("span", { className: "nxp-ftc__badge nxp-ftc__badge--new", "aria-label": "New", children: "NEW" }),
          w && o && /* @__PURE__ */ e(
            "span",
            {
