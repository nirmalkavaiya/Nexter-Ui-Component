...
function z({
  ...
  const u = typeof h == "string" ? h.trim() : "", C = !!u, b = c || l, B = typeof a == "string" && /<[a-z][\s\S]*>/i.test(a);
  function I(m) {
    const j = { target: { checked: m } };
    o == null || o(j), d == null || d(m);
  }
  const M = [
    "nxp-ftc-outer"
  ...
  return /* @__PURE__ */ n("div", { className: M, children: [
    C && /* @__PURE__ */ e("span", { className: "nxp-ftc-plan", children: u }),
    /* @__PURE__ */ n("div", { className: A, children: [
      /* @__PURE__ */ n("div", { className: "nxp-ftc__body", children: [
        /* @__PURE__ */ n("div", { className: "nxp-ftc__title-row", children: [
          ...
          p && /* @__PURE__ */ e($, { content: p, children: /* @__PURE__ */ e(
            "span",
            {
