...
import "react";
import { Toggle as W } from "../Toggle/Toggle.js";
...
function S({
  ...
  const m = typeof h == "string" ? h.trim() : "", C = !!m, u = c || l, B = typeof a == "string" && /<[a-z][\s\S]*>/i.test(a);
  function I(b) {
    const j = { target: { checked: b } };
    o == null || o(j), d == null || d(b);
  }
  const M = [
    "nxp-ftc-outer"
    ...
    /* @__PURE__ */ n("div", { className: A, children: [
      /* @__PURE__ */ n("div", { className: "nxp-ftc__body", children: [
        /* @__PURE__ */ n("div", { className: "nxp-ftc__title-row", children: [
          ...
          p && /* @__PURE__ */ e(H, { content: p, children: /* @__PURE__ */ e(
            "span",
            {
