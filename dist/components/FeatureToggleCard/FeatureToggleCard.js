...
const D = () => /* @__PURE__ */ n("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", "aria-hidden": "true", children: [
...
] }), V = () => /* @__PURE__ */ e("svg", { width: "11", height: "11", viewBox: "0 0 11 11", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ e("path", { d: "M2 5.5h7M6 3l3 2.5L6 8", stroke: "currentColor", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round" }) }), g = {
...
function q({
  ...
  const m = typeof h == "string" ? h.trim() : "", B = !!m, u = c || l, I = typeof a == "string" && /<[a-z][\s\S]*>/i.test(a);
  function M(b) {
    const L = { target: { checked: b } };
    o == null || o(L), d == null || d(b);
  }
  const A = [
    "nxp-ftc-outer"
  ...
  return /* @__PURE__ */ n("div", { className: A, children: [
    B && /* @__PURE__ */ e("span", { className: "nxp-ftc-plan", children: m }),
    /* @__PURE__ */ n("div", { className: j, children: [
      /* @__PURE__ */ n("div", { className: "nxp-ftc__body", children: [
        /* @__PURE__ */ n("div", { className: "nxp-ftc__title-row", children: [
          ...
          p && /* @__PURE__ */ e(R, { content: p, position: y, children: /* @__PURE__ */ e(
            "span",
            {
