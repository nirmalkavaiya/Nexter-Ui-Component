...
import { useCallback as $, useMemo as j } from "react";
import { cn as z } from "../../lib/utils.js";
import { Toggle as D } from "../Toggle/Toggle.js";
import { Tooltip as P } from "../Tooltip/Tooltip.js";
import { sanitizeHtml as R } from "../../lib/sanitize.js";
...
function K({
  ...
  const h = typeof d == "string" ? d.trim() : "", M = !!h, b = e || n, A = typeof t == "string" && /<[a-z][\s\S]*>/i.test(t), C = $(
    (g) => {
    ...
    () => z("nxp-ftc nxp-bg-default nxp-p-20 nxp-rounded-md", e && "nxp-ftc--locked", n && "nxp-ftc--disabled", m),
    [e, n, m]
  );
    ...
    /* @__PURE__ */ c("div", { className: B, children: [
      /* @__PURE__ */ c("div", { className: "nxp-ftc__body", children: [
        /* @__PURE__ */ c("div", { className: "nxp-ftc__title-row", children: [
          ...
          i && /* @__PURE__ */ a(P, { content: i, position: I, children: /* @__PURE__ */ a(
            "span",
            {
