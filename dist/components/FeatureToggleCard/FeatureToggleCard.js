...
import { sanitizeHtml as W } from "../../lib/sanitize.js";
const $ = () => /* @__PURE__ */ n("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", "aria-hidden": "true", children: [
...
function q({
  ...
  const m = typeof f == "string" ? f.trim() : "", C = !!m, b = t || r, I = typeof a == "string" && /<[a-z][\s\S]*>/i.test(a);
  function M(u) {
    const H = { target: { checked: u } };
    s == null || s(H), d == null || d(u);
  }
  const A = [
    "nxp-ftc-outer"
  ...
  return /* @__PURE__ */ n("div", { className: A, children: [
    C && /* @__PURE__ */ e("span", { className: "nxp-ftc-plan", children: m }),
    /* @__PURE__ */ n("div", { className: j, children: [
      /* @__PURE__ */ n("div", { className: "nxp-ftc__body", children: [
        /* @__PURE__ */ n("div", { className: "nxp-ftc__title-row", children: [
          /* @__PURE__ */ e("span", { className: "nxp-title-label nxp-cursor-pointer", children: l }),
          v && /* @__PURE__ */ e("span", { className: "nxp-ftc__badge nxp-ftc__badge--new", "aria-label": "New", children: "NEW" }),
          w && i && /* @__PURE__ */ e(
            "span",
            {
              className: g[k] ?? g.default,
              "aria-label": `${i} feature`,
              children: i
            }
          ),
          p && /* @__PURE__ */ e(L, { content: p, position: y, children: /* @__PURE__ */ e(
            "span",
            {
        ...
        /* @__PURE__ */ n("div", { className: "nxp-ftc__right", children: [
          _ && !t && /* @__PURE__ */ e(
            ...
            {
              type: "button",
              className: "nxp-ftc__settings-btn" + (c ? " setting-enable" : ""),
              onClick: _,
              disabled: !c || r,
      ...
      /* @__PURE__ */ n("div", { className: "nxp-ftc__links", children: [
        a && (I ? /* @__PURE__ */ e(
          "div",
          {
            ...
            dangerouslySetInnerHTML: { __html: W(a) }
          }
        ) : /* @__PURE__ */ e("div", { className: "nxp-body nxp-mt-12 nxp-lh-22", children: a })),
        h && /* @__PURE__ */ e(
          "a",
          {
            href: h,
