...
function k({
  ...
  return /* @__PURE__ */ n("nav", { className: h, "aria-label": "Breadcrumb", children: /* @__PURE__ */ n("ol", { className: "nxp-bc__list", role: "list", children: l.map((e, c) => {
    const a = c === l.length - 1, d = c === 0, r = e.icon ?? (i && d ? /* @__PURE__ */ n(u, {}) : null);
    return /* @__PURE__ */ o("li", { className: "nxp-bc__item", children: [
      ...
      !a && /* @__PURE__ */ n("span", { className: "nxp-bc__sep", "aria-hidden": "true", children: s ?? /* @__PURE__ */ n(p, {}) })
    ] }, c);
  }) }) });
}
export {
