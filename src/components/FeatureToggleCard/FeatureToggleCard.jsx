        ...
        <div className="nxp-ftc__body">
          ...
          <div className="nxp-ftc__right">
            ...
            {redirectLink && isEnabled && (
              <a href={redirectLink} target="_blank" rel="noopener noreferrer" className="nxp-ftc__redirect-link">
            ...
            { onChange &&
              <Toggle
                ...
                isPro={isLocked}
                onProClick={isLocked ? onUpgradeClick : undefined}
              />
            }
          </div>
