...
function Search({ value, onChange, placeholder = 'Search…', onClear, className = '' }) {
  ...
  /* Stable root class */
  const rootClass = useMemo(() => cn('nxp-search', className), [className]);

  return (
    <div className={rootClass}>
      <span className="nxp-search__icon" aria-hidden="true">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" fill="none" viewBox="0 0 16 17">
          <path stroke="#727272" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="m14 14.5-3.4647-3.4646m0 0c.9378-.9378 1.4646-2.20957 1.4646-3.5357s-.5268-2.59795-1.4646-3.53567c-.93768-.93771-2.2095-1.46452-3.53563-1.46452S4.40172 3.02632 3.464 3.96403c-.93771.93772-1.46452 2.20954-1.46452 3.53567s.52681 2.5979 1.46452 3.5357c.93772.9377 2.20954 1.4645 3.53567 1.4645s2.59795-.5268 3.53563-1.4645Z"/>
        </svg>
      </span>
      <input
        type="search"
